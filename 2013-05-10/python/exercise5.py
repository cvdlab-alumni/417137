...
controls222=(BEZIER(S1)([[0.205, -0.410,0],  [0.163, -0.418,0] , [0.125, -0.422,0],  [0.104, -0.430,0]]))

controls333=(BEZIER(S1)([[0.104, -0.430,0],  [0.090,-0.440,0],  [0.084,-0.461,0]]))

controls222_2=(BEZIER(S1)([[0.205, -0.410,0.05],  [0.163, -0.418,0.05] , [0.125, -0.422,0.05],  [0.104, -0.430,0.05]]))

controls333_2=(BEZIER(S1)([[0.104, -0.430,0.05],  [0.090,-0.440,0.05],  [0.084,-0.461,0.05]]))

controls333_2r=COLOR(RED)(MAP(BEZIER(S1)([[0.104, -0.430,0.05],  [0.090,-0.440,0.05],  [0.084,-0.461,0.05]]))(INTERVALS(1)(32)))
controls10=(MAP(BEZIER(S1)([[0.519,-0.453],[0.512,-0.436],[0.503,-0.426],[0.495,-0.418],[0.477,-0.409]]))(INTERVALS(1)(32)))
...
out = MAP(BEZIER(S2)([controls222,controls222_2]))(  Plasm.power(INTERVALS(1)(32),INTERVALS(1)(32))  )
#VIEW(out)


out2 = MAP(BEZIER(S2)([controls333,controls333_2]))(  Plasm.power(INTERVALS(1)(32),INTERVALS(1)(32))  )
#VIEW(STRUCT([out,out2,controls333_2r]))
...
controls2222=(BEZIER(S1)([[0.228, -0.484,0],  [0.222, -0.448,0] , [0.220, -0.418,0],  [0.244, -0.410,0]]))
controls2223=(BEZIER(S1)([[0.324, -0.484,0],  [0.356, -0.481,0] , [0.363, -0.448,0],  [0.366, -0.414,0]]))

outCof = MAP(BEZIER(S2)([controls2223,controls2222]))(  Plasm.power(INTERVALS(1)(32),INTERVALS(1)(32))  )
outCof=COLOR(BLACK)(outCof)
...
outCof=S([1,2,3])([23,23,23])(outCof)
outCof=T([1,2])([-6,11.5])(outCof)
outCof=S([1,2,3])([0.8,0.8,0.8])(outCof)
outCof=T([3])([2])(outCof)
outCof=T([1,2])([-0.4,0.35])(outCof)

outCof2=T([3])([-3.9])(outCof)

#VIEW(STRUCT([profileTotal,ruote,volante,outCof]))


#tettuccio
controls_333_1 = (BEZIER(S1)([[7.1,4.61,0.8],[7,4.8,0.7],[8,5.20,0.6],[10.55,5.4,0.8],[12.55,4.95,0.7]]))
controls_333_2 = (BEZIER(S1)([[7.1,4.61,5.2],[7,4.8,5.3],[8,5.20,5.4],[10.55,5.4,5.2],[12.55,4.95,5.3]]))
outCof2i = MAP(BEZIER(S2)([controls_333_1,controls_333_2]))(  Plasm.power(INTERVALS(1)(32),INTERVALS(1)(32))  )

#striscia1
controlsy_22_1 = (BEZIER(S1)([[6,3.69,5.3],[7,5.173,5.2],[8,5.27,5.4],[10.55,5.41,5.2],[12.55,5.07,5],[14.55,4.47,5]]))
controlsy_22_2 = (BEZIER(S1)([[6,3.69,5.5],[7,5.173,5.5],[8,5.27,5.7],[10.55,5.41,5.5],[12.55,5.07,5.3],[14.55,4.47,5.9]]))

outCof3=MAP(BEZIER(S2)([controlsy_22_1,controlsy_22_2]))(  Plasm.power(INTERVALS(1)(32),INTERVALS(1)(32))  )

#striscia2
controlsy_134_1 =(BEZIER(S1)( [[6,3.69,0.6],[7,5.173,0.5],[8,5.27,0.3],[10.55,5.4,0.5],[12.55,5.07,0.7],[14.55,4.47,0]]))
controlsy_134_2 =(BEZIER(S1)( [[6,3.69,0.8],[7,5.173,0.8],[8,5.27,0.6],[10.55,5.4,0.8],[12.55,5.07,1],[14.55,4.47,1]]))

outCof4=MAP(BEZIER(S2)([controlsy_134_1,controlsy_134_2]))(  Plasm.power(INTERVALS(1)(32),INTERVALS(1)(32))  )

tettuccio=(STRUCT([outCof4,outCof3,outCof2i]))

tettuccio=S([1,2,3])([0.5,0.5,0.5])(tettuccio)
tettuccio=T([1,3])([-5,-1.6])(tettuccio)
tettuccio=T(2)(0.4)(tettuccio)
tettuccio=T(1)(0.4)(tettuccio)
tettuccio=S([1,2,3])([1.1,1.1,1.1])(tettuccio)
tettuccio=T(2)(-0.15)(tettuccio)
tettuccio=T(3)(0.1)(tettuccio)
tettuccio=S([1,2,3])([1.1,1.1,1.1])(tettuccio)
tettuccio=COLOR(BLACK)(tettuccio)
tettuccio=T(2)(-0.26)(tettuccio)

VIEW(STRUCT([profileTotal,ruote,volante,outCof,tettuccio,outCof2]))
